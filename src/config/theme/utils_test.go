...
func TestDecodeColors(t *testing.T) {
	...
	cases := map[string][]byte{
		"deab12"   : []byte{0xde, 0xab, 0x12, 0xff}, // RGB
		"#deab12"  : []byte{0xde, 0xab, 0x12, 0xff}, // RGB with prefix
		"12345678" : []byte{0x12, 0x34, 0x56, 0x78}, // RGBA
		"#12345678": []byte{0x12, 0x34, 0x56, 0x78}, // RGBA with prefix
		"FFFFFF"   : []byte{0xff, 0xff, 0xff, 0xff}, // Upper case
	}
